-- Add customer delivery confirmation fields to wms_orders
...
-- Create function to auto-generate invoice on customer confirmation
...
DROP TRIGGER IF EXISTS trigger_auto_generate_invoice_on_confirmation ON public.wms_orders;

CREATE TRIGGER trigger_auto_generate_invoice_on_confirmation
BEFORE UPDATE ON public.wms_orders
FOR EACH ROW
EXECUTE FUNCTION public.auto_generate_invoice_on_customer_confirmation();